...
ControllerAll = false
local ListSudos ={Sudo_Id,6887054803}  
...
if tonumber(msg.sender.user_id) == 6887054803 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 6887054803 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 6887054803 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/xo55x'}, },}}
...
--download('https://raw.githubusercontent.com/roger88881/ALsultan/master/ALsultan.lua','ALsultan.lua')
...
data = {
{
{text = 'قناة السورس', url = 't.me/xo55x'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/xo55x'}, 
},
{
{text = 'Annotations Source', url = 't.me/infoALsultan'}, 
},
{
{text = 'Communication Source', url = 't.me/ALsuItanBoT'}, 
},
{
{text = 'Developer Source !', url = 't.me/mYroger'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(ALsultan.."ALsultan:Name:Bot") or "ميلانو") then
local NamesBot = (Redis:get(ALsultan.."ALsultan:Name:Bot") or "ميلانو")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(ALsultan.."ALsultan:Name:Bot") or "ميلانو")..
